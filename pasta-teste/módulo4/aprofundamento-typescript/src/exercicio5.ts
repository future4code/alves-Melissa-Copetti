...
// Essas opções são válidas nesse arquivo. "strict": true,   "esModuleInterop": true, "forceConsistentCasingInFileNames": true 
//"sourceMap": true, "outDir": "./build", "rootDir": "./src", "removeComments": true,  "noImplicitAny": true, "include": ["src/**/*"], "exclude": ["node_modules"]
