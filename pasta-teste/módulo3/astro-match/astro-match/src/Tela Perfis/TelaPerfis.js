...
import { ButtonsCardD, ButtonsCardL, QuadroImg, ButtonBox, ImgCard, ImgFundo, NameAge } from "./Stiled";
      ...
      .then((resposta) => {
        if (resposta.data.isMatch) {
          Swal.fire({
            ...
            text: ':(',
            imageUrl: 'https://media2.giphy.com/media/2CdwFeWTJ2xFK/giphy.gif?cid=ecf05e479j7jp6e9uwpd0mrsi97p101fb9cszgkt8hasudyy&rid=giphy.gif&ct=g',
            imageWidth: 300,
            imageHeight: 200,
